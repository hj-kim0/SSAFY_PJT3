...
|팀원|느낀점|
|-----|---|
|조덕희|K 문제 상황을 공유하고 빠른 해결을 위해 도움을 요청하고 힘을 합쳐 문제 해결
P 애매모호한 지라 활용 및 각자 진행상황 공유 
T 명확한 지라 이슈 설정 및 지속적인 진행상황 공유|
|박주윤|K 역량 향상을 위한 지속적인 학습
P  예상 결과 및 진행상황에 대한 공유 미흡
T 사전 데이터 분석 및 객체지향 설계 원칙 지키기|
|김혁주|K 프론트와 백의 지속적인 소통 P 기획단계에서 strict하게 모든 json 형식 및 명명법 확정  
T 코드 리팩토링 및 클린코드 생활화|
|-----|---|
|-----|---|
|-----|---|
