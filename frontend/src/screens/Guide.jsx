    ...
    <div className="guide_body">
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          이름에 걸맞게 컴퓨터를 통제하는 핵심적인 장치입니다. <br />
          컴퓨터를 하나의 농장으로 비유하면
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          동시에 더 많은 프로그램을 실행하게 해주는 장치입니다. <br />
          컴퓨터를 하나의 농장으로 비유하면 <br />
          수확물을 옮길 수 있는 수레의 크기라고 할 수 있습니다. <br/>
          옥수수를 많이 따도 수레가 작으면 한번에 가져가지 못하기 때문에 <br />
           다다익램이라는 말이 있습니다.
        </p>
      </div>
      <div className="parts_bind">
        ...
        <p>
          ...
          그래픽작업을 전문으로 처리하는 영상송출 장치입니다. <br />
          컴퓨터를 하나의 농장으로 비유하면
          <br /> 옥수수 수확에는 서투르지만,
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          더 많은 자료를 저장해주는 장치입니다. <br />
          컴퓨터를 하나의 농장으로 비유하면
          <br /> 시설은 구형이지만, <br/>
          넓고 저렴한 수확물 저장 창고와 같다고 할 수있습니다.
        </p>
      </div>
      <div className="parts_bind">
        ...
        <p>
          ...
          빠르게 자료를 읽어주는 장치입니다. <br />
          컴퓨터를 하나의 농장으로 비유하면
          <br /> 가격이 비싸지만, 최신 시설의 수확물 저장 창고와 같다고 할 수
          있습니다. <br/>
          RAM 과 비슷하게 생긴 MVMe방식 SSD는 안에 컨베이어 벨트까지 깔린 <br/>
          최신 시설의 가장 빠른 저장 창고라고 할 수 있습니다.
        </p>
      </div>
      <div className="parts_bind">
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          모든 부품들을 적재적소에 배치하며, 외관을 담당하는 장치입니다.{" "}
          <br />
          컴퓨터를 하나의 농장으로 비유하면
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          모든 부품들에게 일정량 이상의 전원을 공급해주는 장치입니다. <br />
      ...
      <div className="parts_bind">
        ...
        <p>
          ...
          부품들을 사용할수록 열이 발생하는데 열을 발산해주는 장치입니다.{" "}
          <br />
          컴퓨터를 하나의 농장으로 비유하면
